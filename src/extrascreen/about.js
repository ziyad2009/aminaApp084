...
break;
    ...
    return(
        <Box mt={Platform.OS==='android'?58:44} background='white' flex={1}>
            <Text  fontSize={18}  fontWeight='bold' textAlign={'left'}  ml='4'
            ...
            { slide===1?<Stack borderWidth={1}  borderRadius={10} borderColor={Colors.AminaButtonNew} padding={6} w="97%" justifyContent={'center'} alignItems='center' ml={2} >
              <Text fontSize={18}  fontWeight='bold' textAlign={'left'}  ml='1'
