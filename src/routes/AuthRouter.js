...
import ModalScreen from '../services/utils/mainmodal';
    ...
    <Box>
      ...
      {Platform.OS === 'android' ? (
        <HStack>
          ...
          <Logo
            width={Metrics.HEIGHT * 0.1321}
            height={Metrics.HEIGHT * 0.044}
          />
        </HStack>
      ) : (
        <HStack>
          <Logo
            width={Metrics.HEIGHT * 0.1021}
...
const StackNav = () => {
  return (
    <Stack.Navigator>
      <Stack.Screen
        name={Platform.OS === 'android' ? ' ' : 'HomeTap'}
        component={HomeTap}
        options={({rout, navigation}) => ({
          ...
          // headerShown: true ,
          headerLeft: () => {
            return <HeaderBackButton val={navigation} />;
          },
          headerRight: () => {
      ...
      <Stack.Screen
        ...
        options={({route, navigation}) => ({
          headerTitle:
            Platform.OS === 'android' ? route.params.productTitle : '',
          headerTransparent: true,
          headerStyle: {
            backgroundColor: Colors.hederup,
          },
      ...
      <Stack.Screen
        name="BabysetesrsProfile"
        component={BabysetesrsProfile}
        options={({route, navigation}) => ({
          headerTitle:
            Platform.OS === 'android' ? route.params.settertTitle : '',
          headerTransparent: true,
          headerStyle: {
            backgroundColor: Colors.hederup,
          },
    ...
    <Tab.Navigator
      ...
      screenOptions={({route}) => ({
        ...
        tabBarIcon: ({focused, size, color}) => {
          ...
          if (route.name === 'Home') {
            Iconname =
              'https://res.cloudinary.com/djzx0zqms/image/upload/v1699876986/aminaicon/home_ggbwys.png';
            size = focused ? 28 : 22;
            color = focused ? Colors.AminabackgroundColor : Colors.transparent;
          } else if (route.name === 'Favourite') {
            Iconname =
              'https://res.cloudinary.com/djzx0zqms/image/upload/v1699876986/aminaicon/fav_tfzla1.png';
            size = focused ? 28 : 22;
            color = focused ? Colors.AminabackgroundColor : Colors.transparent;
          } else if (route.name === 'Request') {
            Iconname =
              'https://res.cloudinary.com/djzx0zqms/image/upload/v1699876986/aminaicon/request_pizuxj.png';
            size = focused ? 28 : 22;
            color = focused ? Colors.AminabackgroundColor : Colors.transparent;
          } else if (route.name === 'Wallet') {
            Iconname =
              'https://res.cloudinary.com/djzx0zqms/image/upload/v1699876986/aminaicon/acount_hulnnz.png';
            size = focused ? 28 : 22;
            color = focused ? Colors.AminabackgroundColor : Colors.transparent;
          } else if (route.name === 'Notification') {
            Iconname =
              'https://res.cloudinary.com/djzx0zqms/image/upload/v1677668600/aminaicon/notifactiion_km9yin.svg';
            size = focused ? 28 : 22;
            color = focused ? Colors.AminabackgroundColor : Colors.transparent;
          }
          return (
            ...
            <Image
              source={{uri: Iconname}}
              style={{
                width: widthPixel(Platform.OS === 'android' ? 27 : 15),
                height: heightPixel(Platform.OS === 'android' ? 30 : 20),
        ...
        tabBarStyle: {
          backgroundColor:Platform.OS==='android'? Colors.AminabackgroundColor: Colors.transparent,
          borderRadius: 55,
          borderWidth: 0.2,
          borderColor: Colors.text,
          // borderTopColor:Colors.textZahry,
          //borderWidth:.5,
          // paddingLeft:10,
          //paddingRight:10
        },
...
const Navigation = () => {
  ...
  //   )
  // }
  const {loading, loginbyphone, user, verify, regUser, home} =
    React.useContext(UserContext);
  return (
    <NavigationContainer>
      {!home ? <Authflow /> : <StackNav />}
    </NavigationContainer>
  );
};
