...
const appCredentials = {
   // production_secrete_key: (Platform.OS == 'ios') ? 'iOS-Live-KEY' : 'Android-Live-KEY',
    ...
    sandbox_secrete_key: (Platform.OS == 'ios') ? 'sk_test_7Mt4HAopWkVG5IqJQnE9ZKDC' :  'sk_test_7Mt4HAopWkVG5IqJQnE9ZKDC',
    bundleID: (Platform.OS == 'ios') ? 'com.Aminah8530.aminahapp231084' :  'com.amenid084',
}
